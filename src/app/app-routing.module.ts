...
{ path: 'FrontacceuilComponent', component: FrontacceuilComponent },

{ path: '', component: LoginbyadminComponent },

{ path: 'FrontroomComponent', component: FrontroomComponent },



{ path: 'FronthotelsComponentComponent', component: FronthotelsComponentComponent },
{ path: 'Frontroom1Component', component: Frontroom1Component },
{ path: 'Frontroom2Component', component: Frontroom2Component },
{ path: 'Frontroom3Component', component: Frontroom3Component },
{ path: 'FrontspaComponent', component: FrontspaComponent },
{ path: 'FrontrestaurantComponent', component: FrontrestaurantComponent },
{ path: 'FrontactivitesComponent', component: FrontactivitesComponent },
{ path: 'FrontcontactComponent', component: FrontcontactComponent },
{ path: 'FrontaboutComponent', component: FrontaboutComponent },
{ path: 'FronttestimonialComponent', component: FronttestimonialComponent },
{ path: 'FrontblogComponent', component: FrontblogComponent },
{ path: 'FrontgalerieComponent', component: FrontgalerieComponent },
{ path: 'FrontheaderComponent', component: FrontheaderComponent },
{ path: 'FrontfooterComponent', component: FrontfooterComponent },
{ path: 'FrontmenuComponent', component: FrontmenuComponent },
{ path: 'FrontcontenuComponent', component: FrontcontenuComponent },




  { path: 'login', component: LoginbyadminComponent },


  { path: 'Agencecreatedetailreservation1childrenComponent', component:  Agencecreatedetailreservation1childrenComponent }, 
  { path: 'Agencecreatedetailreservation2childrenComponent', component:  Agencecreatedetailreservation2childrenComponent }, 
  { path: 'Agencecreatedetailreservation3childrenComponent', component:  Agencecreatedetailreservation3childrenComponent }, 
  { path: 'Agencecreatedetailreservation4childrenComponent', component:  Agencecreatedetailreservation4childrenComponent }, 
  { path: 'Agencecreatedetailreservation5childrenComponent', component:  Agencecreatedetailreservation5childrenComponent }, 
  { path: 'Agencecreatedetailreservation6childrenComponent', component:  Agencecreatedetailreservation6childrenComponent }, 
  { path: 'Agencecreatedetailreservation7childrenComponent', component:  Agencecreatedetailreservation7childrenComponent }, 
  { path: 'Agencecreatedetailreservation8childrenComponent', component:  Agencecreatedetailreservation8childrenComponent }, 
  { path: 'Agencecreatedetailreservation9childrenComponent', component:  Agencecreatedetailreservation9childrenComponent }, 



  { path: 'agencecreateonechambre', component:  AgencecreateonechambreComponent }, 
  { path: 'agencecreatetwochambre', component:  AgencecreatetwochambreComponent }, 
  { path: 'agencecreatethreeechambre', component:  AgencecreatethreeechambreComponent }, 
  { path: 'agencecreatefoourchambre', component:  AgencecreatefoourchambreComponent }, 
  { path: 'agencecreatefivechambre', component:  AgencecreatefivechambreComponent }, 




  { path: 'admincreerchambres/:id', component:  CreatechambresbyadminComponent }, 
  { path: 'admincreercritere/:id', component:  CreatecriteresbyadminComponent }, 
  { path: 'admincreerhotelphoto/:id', component:  CreatehotelPhotosbyadminComponent }, 
  { path: 'admincreerhotel', component:  CreatehotelsbyadminComponent }, 
  { path: 'admincreernoteagence', component:  CreatenoteAgencebyadminComponent }, 
  { path: 'admincreernotehotel', component:  CreatenoteHotelbyadminComponent }, 
  { path: 'admincreerreservationdetail', component:  CreatereservationDetailsbyadminComponent } ,
  { path: 'admincreerreservation', component:  CreatereservationsbyadminComponent }, 
  { path: 'admincreeruser', component:  CreateusersbyadminComponent }, 



  { path: 'admineditchambre/:id', component:  EditchambresbyadminComponent }, 
  { path: 'admineditcrietre/:id', component:  EditcriteresbyadminComponent }, 
  { path: 'adminedithotelphoto/:id', component:  EdithotelPhotosbyadminComponent }, 
  { path: 'adminedithotel/:id', component:  EdithotelsbyadminComponent }, 
  { path: 'admineditnoteagence/:id', component:  EditnoteAgencebyadminComponent }, 
  { path: 'admineditnotehotel/:id', component:  EditnoteHotelbyadminComponent }, 
  { path: 'admineditreservationdetail/:id', component:  EditreservationDetailsbyadminComponent }, 
  { path: 'admineditreservation/:id', component:  EditreservationsbyadminComponent }, 
  { path: 'adminedituser/:id', component:  EditusersbyadminComponent }, 
  { path: 'adminlistchambre', component:  ListchambresbyadminComponent }, 
{ path: 'adminlistcritere', component:  ListcriteresbyadminComponent }, 
{ path: 'adminlisthotelphoto', component:  ListhotelPhotosbyadminComponent }, 
{ path: 'adminlisthotel', component:  ListhotelsbyadminComponent }, 
{ path: 'adminlistnoteagence', component:  ListnoteAgencebyadminComponent }, 
{ path: 'adminlistnotehotel', component:  ListnoteHotelbyadminComponent }, 
{ path: 'adminlistreservationdetail', component:  ListreservationDetailsbyadminComponent }, 
{ path: 'adminlistreservation', component:  ListreservationsbyadminComponent }, 
{ path: 'adminlistuser', component:  ListusersbyadminComponent }, 


{ path: 'admindetailchambre/:id', component:  DetailchambresbyadminComponent }, 
{ path: 'admindetailcritere/:id', component:  DetailcriteresbyadminComponent }, 
{ path: 'admindetailhotelphoto/:id', component:  DetailhotelPhotosbyadminComponent }, 
{ path: 'admindetailhotel/:id', component:  DetailhotelsbyadminComponent }, 
{ path: 'admindetailnoteagence/:id', component:  DetailnoteAgencebyadminComponent }, 
{ path: 'admindetailnotehotel/:id', component:  DetailnoteHotelbyadminComponent }, 
{ path: 'admindetailreservationdetail/:id', component:  DetailreservationDetailsbyadminComponent }, 
{ path: 'admindetailreservation/:id', component:  DetailreservationsbyadminComponent }, 
{ path: 'admindetailuser/:id', component:  DetailusersbyadminComponent }, 

{ path: 'adminlogin', component:  LoginbyadminComponent }, 
{ path: 'adminregister', component:  RegitserbyadminComponent }, 
{ path: 'adminheader', component:  HeaderbyadminComponent }, 
{ path: 'adminfooter', component:  FooterbyadminComponent }, 
{ path: 'adminmenu', component:  MenubyadminComponent }, 


{ path: 'agencecreerchambre', component:  CreatechambresbyagenceComponent }, 
{ path: 'agencecreercritere', component:  CreatecriteresbyagenceComponent }, 
{ path: 'agencecreerhotelphoto', component:  CreatehotelPhotosbyagenceComponent }, 
{ path: 'agencecreerhotel', component:  CreatehotelsbyagenceComponent }, 
{ path: 'agencecreernoteagence', component:  CreatenoteAgencebyagenceComponent }, 
{ path: 'agencecreernotehotel', component:  CreatenoteHotelbyagenceComponent }, 
{ path: 'agencecreerreservationdetail', component:  CreatereservationDetailsbyagenceComponent }, 
{ path: 'agencecreerreservation', component:  CreatereservationsbyagenceComponent }, 
{ path: 'agencecreeruser', component:  CreateusersbyagenceComponent }, 



{ path: 'agenceeditchambre/:id', component:  EditchambresbyagenceComponent }, 
{ path: 'agenceeditcritere/:id', component:  EditcriteresbyagenceComponent }, 
{ path: 'agenceedithotelphoto/:id', component:  EdithotelPhotosbyagenceComponent }, 
{ path: 'agenceedithotel/:id', component:  EdithotelsbyagenceComponent }, 
{ path: 'agenceeditnoteagence/:id', component:  EditnoteAgencebyagenceComponent }, 
{ path: 'agenceeditnotehotel/:id', component:  EditnoteHotelbyagenceComponent }, 
{ path: 'agenceeditreservationdetail/:id', component:  EditreservationDetailsbyagenceComponent }, 
{ path: 'agenceeditreservation/:id', component:  EditreservationsbyagenceComponent }, 
{ path: 'agenceedituser/:id', component:  EditusersbyagenceComponent }, 

{ path: 'agencelistchambre', component:  ListchambresbyagenceComponent }, 
{ path: 'agencelistcritere', component:  ListcriteresbyagenceComponent }, 
{ path: 'agencelisthotelphoto', component:  ListhotelPhotosbyagenceComponent }, 
{ path: 'agencelisthotel', component:  ListhotelsbyagenceComponent }, 
{ path: 'agencelistnoteagence', component:  ListnoteAgencebyagenceComponent }, 
{ path: 'agencelistnotehotel', component:  ListnoteHotelbyagenceComponent }, 
{ path: 'agencelistreservationdetail', component:  ListreservationDetailsbyagenceComponent }, 
{ path: 'agencelistreservation', component:  ListreservationsbyagenceComponent }, 
{ path: 'agencelistuser', component:  ListusersbyagenceComponent }, 


{ path: 'agencedetailchambre/:id', component:  DetailchambresbyagenceComponent }, 
{ path: 'agencedetailcritere/:id', component:  DetailcriteresbyagenceComponent }, 
{ path: 'agencedetailhotelphoto/:id', component:  DetailhotelPhotosbyagenceComponent }, 
{ path: 'agencedetailhotel/:id', component:  DetailhotelsbyagenceComponent }, 
{ path: 'agencedetailnoteagence/:id', component:  DetailnoteAgencebyagenceComponent }, 
{ path: 'agencedetailnotehotel/:id', component:  DetailnoteHotelbyagenceComponent }, 
{ path: 'agencedetailreservationdetail/:id', component:  DetailreservationDetailsbyagenceComponent }, 
{ path: 'agencedetailreservation/:id', component:  DetailreservationsbyagenceComponent }, 
{ path: 'agencedetailuser/:id', component:  DetailusersbyagenceComponent }, 
{ path: 'agencelogin', component:  LoginbyagenceComponent }, 
{ path: 'agenceregister', component:  RegitserbyagenceComponent }, 
{ path: 'agenceheader', component:  HeaderbyagenceComponent }, 
{ path: 'agencefooter', component:  FooterbyagenceComponent }, 
{ path: 'agencemenu', component:  MenubyagenceComponent }, 

{ path: 'clientcreerchambre', component:  CreatechambresbyclientComponent }, 
{ path: 'clientcreercritere', component:  CreatecriteresbyclientComponent }, 
{ path: 'clientcreerhotelphoto', component:  CreatehotelPhotosbyclientComponent }, 
{ path: 'clientcreerhotel', component:  CreatehotelsbyclientComponent }, 
{ path: 'clientcreernoteagence', component:  CreatenoteAgencebyclientComponent }, 
{ path: 'clientcreernotehotel', component:  CreatenoteHotelbyclientComponent }, 
{ path: 'clientcreerreservationdetail', component:  CreatereservationDetailsbyclientComponent }, 
{ path: 'clientcreerreservation', component:  CreatereservationsbyclientComponent }, 
{ path: 'clientcreeruser', component:  CreateusersbyclientComponent },


{ path: 'clienteditchambre/:id', component:  EditchambresbyclientComponent }, 
{ path: 'clienteditcritere/:id', component:  EditcriteresbyclientComponent }, 
{ path: 'clientedithotelphoto/:id', component:  EdithotelPhotosbyclientComponent }, 
{ path: 'clientedithotel/:id', component:  EdithotelsbyclientComponent }, 
{ path: 'clienteditnoteagence/:id', component:  EditnoteAgencebyclientComponent }, 
{ path: 'clienteditnotehotel/:id', component:  EditnoteHotelbyclientComponent }, 
{ path: 'clienteditreservationdetail/:id', component:  EditreservationDetailsbyclientComponent }, 
{ path: 'clienteditreservation/:id', component:  EditreservationsbyclientComponent }, 
{ path: 'clientedituser/:id', component:  EditusersbyclientComponent },


{ path: 'clientlistchambre', component:  ListchambresbyclientComponent }, 
{ path: 'clientlistcritere', component:  ListcriteresbyclientComponent }, 
{ path: 'clientlisthotelphoto', component:  ListhotelPhotosbyclientComponent }, 
{ path: 'clientlisthotel', component:  ListhotelsbyclientComponent }, 
{ path: 'clientlistnoteagence', component:  ListnoteAgencebyclientComponent }, 
{ path: 'clientlistnotehotel', component:  ListnoteHotelbyclientComponent }, 
{ path: 'clientlistreservationdetail', component:  ListreservationDetailsbyclientComponent }, 
{ path: 'clientlistreservation', component:  ListreservationsbyclientComponent }, 
{ path: 'clientlistuser', component:  ListusersbyclientComponent },



{ path: 'clientdetailchambre/:id', component:  DetailchambresbyclientComponent }, 
{ path: 'clientdetailcritere/:id', component:  DetailcriteresbyclientComponent }, 
{ path: 'clientdetailhotelphoto/:id', component:  DetailhotelPhotosbyclientComponent }, 
{ path: 'clientdetailhotel/:id', component:  DetailhotelsbyclientComponent }, 
{ path: 'clientdetailnoteagence/:id', component:  DetailnoteAgencebyclientComponent }, 
{ path: 'clientdetailnotehotel/:id', component:  DetailnoteHotelbyclientComponent }, 
{ path: 'clientdetailreservationdetail/:id', component:  DetailreservationDetailsbyclientComponent }, 
{ path: 'clientdetailreservation/:id', component:  DetailreservationsbyclientComponent }, 
{ path: 'clientdetailuser/:id', component:  DetailusersbyclientComponent },


{ path: 'clientlogin', component:  LoginbyclientComponent }, 
{ path: 'clientregister', component:  RegitserbyclientComponent }, 
{ path: 'clientheader', component:  HeaderbyclientComponent }, 
{ path: 'clientfooter', component:  FooterbyclientComponent } ,
{ path: 'clientmenu', component:  MenubyclientComponent }, 
