...
@Component({
  selector: 'app-agencecreatedetailreservation1children',
  templateUrl: './agencecreatedetailreservation1children.component.html',
  styleUrls: ['./agencecreatedetailreservation1children.component.css']
})
export class Agencecreatedetailreservation1childrenComponent {
