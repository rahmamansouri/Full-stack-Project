...
@Component({
  selector: 'app-agencecreatedetailreservation2children',
  templateUrl: './agencecreatedetailreservation2children.component.html',
  styleUrls: ['./agencecreatedetailreservation2children.component.css']
})
export class Agencecreatedetailreservation2childrenComponent {
