...
@Component({
  selector: 'app-editreservation-detailsbyadmin',
  templateUrl: './editreservation-detailsbyadmin.component.html',
  styleUrls: ['./editreservation-detailsbyadmin.component.css']
})
export class EditreservationDetailsbyadminComponent {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatereservationDetails(id, this.editForm.value).subscribe({
          complete: () => {
            ...
            //this.router.navigateByUrl('/adminlistreservationdetail');
