...
@Component({
  selector: 'app-detailusersbyadmin',
  templateUrl: './detailusersbyadmin.component.html',
  styleUrls: ['./detailusersbyadmin.component.css']
})
export class DetailusersbyadminComponent {
  //---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
