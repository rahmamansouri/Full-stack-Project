...
@Component({
  selector: 'app-detailnote-agencebyagence',
  templateUrl: './detailnote-agencebyagence.component.html',
  styleUrls: ['./detailnote-agencebyagence.component.css']
})
export class DetailnoteAgencebyagenceComponent {
  //---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
