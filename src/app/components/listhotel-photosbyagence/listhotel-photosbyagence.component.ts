...
@Component({
  selector: 'app-listhotel-photosbyagence',
  templateUrl: './listhotel-photosbyagence.component.html',
  styleUrls: ['./listhotel-photosbyagence.component.css']
})
export class ListhotelPhotosbyagenceComponent {
