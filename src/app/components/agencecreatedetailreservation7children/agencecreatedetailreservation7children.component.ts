...
@Component({
  selector: 'app-agencecreatedetailreservation7children',
  templateUrl: './agencecreatedetailreservation7children.component.html',
  styleUrls: ['./agencecreatedetailreservation7children.component.css']
})
export class Agencecreatedetailreservation7childrenComponent {
