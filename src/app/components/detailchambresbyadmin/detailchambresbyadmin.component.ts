...
@Component({
  selector: 'app-detailchambresbyadmin',
  templateUrl: './detailchambresbyadmin.component.html',
  styleUrls: ['./detailchambresbyadmin.component.css']
})
export class DetailchambresbyadminComponent {
  submitted = false;
  editForm: FormGroup;
