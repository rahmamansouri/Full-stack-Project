...
@Component({
  selector: 'app-createreservation-detailsbyagence',
  templateUrl: './createreservation-detailsbyagence.component.html',
  styleUrls: ['./createreservation-detailsbyagence.component.css']
})
export class CreatereservationDetailsbyagenceComponent {
  submitted = false;
