...
@Component({
  selector: 'app-detailchambresbyagence',
  templateUrl: './detailchambresbyagence.component.html',
  styleUrls: ['./detailchambresbyagence.component.css']
})
export class DetailchambresbyagenceComponent {
//---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
