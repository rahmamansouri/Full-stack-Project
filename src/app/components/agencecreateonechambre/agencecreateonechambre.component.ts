...
@Component({
  selector: 'app-agencecreateonechambre',
  templateUrl: './agencecreateonechambre.component.html',
  styleUrls: ['./agencecreateonechambre.component.css']
})
export class AgencecreateonechambreComponent {
...
ngOnInit() {
  ...
  onSubmit() {
      ...
      var ff= yy.length;
      for (let i = 0; i < ff; i++) {
      return this.apiService.createchambressss(i,this.chambresForm.value).subscribe({
        complete: () => {
