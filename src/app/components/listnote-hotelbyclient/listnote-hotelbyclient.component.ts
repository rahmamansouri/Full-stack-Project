...
@Component({
  selector: 'app-listnote-hotelbyclient',
  templateUrl: './listnote-hotelbyclient.component.html',
  styleUrls: ['./listnote-hotelbyclient.component.css']
})
export class ListnoteHotelbyclientComponent {
