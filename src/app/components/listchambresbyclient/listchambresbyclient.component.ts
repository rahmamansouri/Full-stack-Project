...
@Component({
  selector: 'app-listchambresbyclient',
  templateUrl: './listchambresbyclient.component.html',
  styleUrls: ['./listchambresbyclient.component.css']
})
export class ListchambresbyclientComponent {
