...
@Component({
  selector: 'app-editusersbyagence',
  templateUrl: './editusersbyagence.component.html',
  styleUrls: ['./editusersbyagence.component.css']
})
export class EditusersbyagenceComponent {
    //---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
