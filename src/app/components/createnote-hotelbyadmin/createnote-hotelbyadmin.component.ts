...
@Component({
  selector: 'app-createnote-hotelbyadmin',
  templateUrl: './createnote-hotelbyadmin.component.html',
  styleUrls: ['./createnote-hotelbyadmin.component.css']
})
export class CreatenoteHotelbyadminComponent {
