...
@Component({
  selector: 'app-createhotel-photosbyagence',
  templateUrl: './createhotel-photosbyagence.component.html',
  styleUrls: ['./createhotel-photosbyagence.component.css']
})
export class CreatehotelPhotosbyagenceComponent {
      ...
      return this.apiService.createhotelPhotos(this.hotelPhotosForm.value).subscribe({
        complete: () => {
          ...
          this.vauesss="operation realisé avec successs"
           // this.ngZone.run(() => this.router.navigateByUrl('/agencelisthotelphoto'));
        },
        error: (e) => {
          console.log(e);
        },
