...
@Component({
  selector: 'app-detailnote-agencebyclient',
  templateUrl: './detailnote-agencebyclient.component.html',
  styleUrls: ['./detailnote-agencebyclient.component.css']
})
export class DetailnoteAgencebyclientComponent {
  //---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
