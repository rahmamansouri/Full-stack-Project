...
@Component({
  selector: 'app-detailreservation-detailsbyclient',
  templateUrl: './detailreservation-detailsbyclient.component.html',
  styleUrls: ['./detailreservation-detailsbyclient.component.css']
})
export class DetailreservationDetailsbyclientComponent {
  //---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatereservationDetails(id, this.editForm.value).subscribe({
          complete: () => {
            ...
            this.router.navigateByUrl('/reservationDetailss-list');
