...
@Component({
  selector: 'app-detailreservation-detailsbyadmin',
  templateUrl: './detailreservation-detailsbyadmin.component.html',
  styleUrls: ['./detailreservation-detailsbyadmin.component.css']
})
export class DetailreservationDetailsbyadminComponent {
  //---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
