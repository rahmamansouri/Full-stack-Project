...
@Component({
  selector: 'app-agencecreatefivechambre',
  templateUrl: './agencecreatefivechambre.component.html',
  styleUrls: ['./agencecreatefivechambre.component.css']
})
export class AgencecreatefivechambreComponent {
...
this.userId = this.authService.getUserId()
  ...
  mainForm() {
    this.chambresForm = this.fb.group({
      ...
      NumChambre3: ['', [Validators.required]],
      NumChambre4: ['', [Validators.required]],
      NumChambre5: ['', [Validators.required]],
  ...
  onSubmit() {
      ...
      var ff= yy.length;
      for (let i = 0; i < ff; i++) {
      return this.apiService.createchambressssfive(i,this.chambresForm.value).subscribe({
        complete: () => {
