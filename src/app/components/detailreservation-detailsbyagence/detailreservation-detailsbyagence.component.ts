...
@Component({
  selector: 'app-detailreservation-detailsbyagence',
  templateUrl: './detailreservation-detailsbyagence.component.html',
  styleUrls: ['./detailreservation-detailsbyagence.component.css']
})
export class DetailreservationDetailsbyagenceComponent {
  //---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
