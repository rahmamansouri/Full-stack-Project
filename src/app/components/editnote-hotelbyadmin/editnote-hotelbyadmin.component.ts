...
@Component({
  selector: 'app-editnote-hotelbyadmin',
  templateUrl: './editnote-hotelbyadmin.component.html',
  styleUrls: ['./editnote-hotelbyadmin.component.css']
})
export class EditnoteHotelbyadminComponent {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatenoteHotel(id, this.editForm.value).subscribe({
          complete: () => {
            ...
            //this.router.navigateByUrl('/adminlistnotehotel');
