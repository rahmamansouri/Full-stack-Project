...
@Component({
  selector: 'app-listcriteresbyclient',
  templateUrl: './listcriteresbyclient.component.html',
  styleUrls: ['./listcriteresbyclient.component.css']
})
export class ListcriteresbyclientComponent {
