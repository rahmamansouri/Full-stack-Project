...
@Component({
  selector: 'app-editnote-agencebyclient',
  templateUrl: './editnote-agencebyclient.component.html',
  styleUrls: ['./editnote-agencebyclient.component.css']
})
export class EditnoteAgencebyclientComponent {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatenoteAgence(id, this.editForm.value).subscribe({
          complete: () => {
            ...
            //this.router.navigateByUrl('/clientlistnoteagence');
