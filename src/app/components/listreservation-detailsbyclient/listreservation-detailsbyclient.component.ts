...
@Component({
  selector: 'app-listreservation-detailsbyclient',
  templateUrl: './listreservation-detailsbyclient.component.html',
  styleUrls: ['./listreservation-detailsbyclient.component.css']
})
export class ListreservationDetailsbyclientComponent {
