...
@Component({
  selector: 'app-agencecreatedetailreservation6children',
  templateUrl: './agencecreatedetailreservation6children.component.html',
  styleUrls: ['./agencecreatedetailreservation6children.component.css']
})
export class Agencecreatedetailreservation6childrenComponent {
