...
@Component({
  selector: 'app-listreservation-detailsbyadmin',
  templateUrl: './listreservation-detailsbyadmin.component.html',
  styleUrls: ['./listreservation-detailsbyadmin.component.css']
})
export class ListreservationDetailsbyadminComponent {
