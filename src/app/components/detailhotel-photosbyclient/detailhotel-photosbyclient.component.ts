...
@Component({
  selector: 'app-detailhotel-photosbyclient',
  templateUrl: './detailhotel-photosbyclient.component.html',
  styleUrls: ['./detailhotel-photosbyclient.component.css']
})
export class DetailhotelPhotosbyclientComponent {
