...
@Component({
  selector: 'app-editreservationsbyadmin',
  templateUrl: './editreservationsbyadmin.component.html',
  styleUrls: ['./editreservationsbyadmin.component.css']
})
export class EditreservationsbyadminComponent {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatereservations(id, this.editForm.value).subscribe({
          complete: () => {
            ...
            //this.router.navigateByUrl('/adminlistreservation');
