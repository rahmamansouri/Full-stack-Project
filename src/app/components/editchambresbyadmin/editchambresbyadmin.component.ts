...
@Component({
  selector: 'app-editchambresbyadmin',
  templateUrl: './editchambresbyadmin.component.html',
  styleUrls: ['./editchambresbyadmin.component.css']
})
export class EditchambresbyadminComponent {
  submitted = false;
  editForm: FormGroup;
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatechambres(id, this.editForm.value).subscribe({
          complete: () => {
            ...
            //this.router.navigateByUrl('/adminlistchambre');
