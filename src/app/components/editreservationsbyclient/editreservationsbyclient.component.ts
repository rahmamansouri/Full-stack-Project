...
@Component({
  selector: 'app-editreservationsbyclient',
  templateUrl: './editreservationsbyclient.component.html',
  styleUrls: ['./editreservationsbyclient.component.css']
})
export class EditreservationsbyclientComponent {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatereservations(id, this.editForm.value).subscribe({
          complete: () => {
            ...
            //this.router.navigateByUrl('/clientlistreservation');
