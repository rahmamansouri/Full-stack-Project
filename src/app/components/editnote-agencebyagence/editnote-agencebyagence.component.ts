...
@Component({
  selector: 'app-editnote-agencebyagence',
  templateUrl: './editnote-agencebyagence.component.html',
  styleUrls: ['./editnote-agencebyagence.component.css']
})
export class EditnoteAgencebyagenceComponent {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatenoteAgence(id, this.editForm.value).subscribe({
          complete: () => {
            ...
            //this.router.navigateByUrl('/agencelistnoteagence');
