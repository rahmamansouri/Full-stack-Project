...
@Component({
  selector: 'app-editchambresbyclient',
  templateUrl: './editchambresbyclient.component.html',
  styleUrls: ['./editchambresbyclient.component.css']
})
export class EditchambresbyclientComponent {
