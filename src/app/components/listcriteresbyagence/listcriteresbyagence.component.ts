...
@Component({
  selector: 'app-listcriteresbyagence',
  templateUrl: './listcriteresbyagence.component.html',
  styleUrls: ['./listcriteresbyagence.component.css']
})
export class ListcriteresbyagenceComponent {
