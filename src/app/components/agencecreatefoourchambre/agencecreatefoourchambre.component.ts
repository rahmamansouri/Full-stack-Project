...
@Component({
  selector: 'app-agencecreatefoourchambre',
  templateUrl: './agencecreatefoourchambre.component.html',
  styleUrls: ['./agencecreatefoourchambre.component.css']
})
export class AgencecreatefoourchambreComponent {
...
ngOnInit() {
  ...
  onSubmit() {
      ...
      var ff= yy.length;
      for (let i = 0; i < ff; i++) {
      return this.apiService.createchambressssfoour(i,this.chambresForm.value).subscribe({
        complete: () => {
