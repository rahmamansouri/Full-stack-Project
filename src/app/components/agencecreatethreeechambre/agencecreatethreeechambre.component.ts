...
@Component({
  selector: 'app-agencecreatethreeechambre',
  templateUrl: './agencecreatethreeechambre.component.html',
  styleUrls: ['./agencecreatethreeechambre.component.css']
})
export class AgencecreatethreeechambreComponent {
/////////////////////////////////////////
fileArr = [];
imgArr = [];
fileObj = [];
...
ngOnInit() {
  ...
  onSubmit() {
      ...
      var ff= yy.length;
      for (let i = 0; i < ff; i++) {
      return this.apiService.createchambressssthree(i,this.chambresForm.value).subscribe({
        complete: () => {
