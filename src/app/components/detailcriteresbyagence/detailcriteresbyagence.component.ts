...
@Component({
  selector: 'app-detailcriteresbyagence',
  templateUrl: './detailcriteresbyagence.component.html',
  styleUrls: ['./detailcriteresbyagence.component.css']
})
export class DetailcriteresbyagenceComponent {
