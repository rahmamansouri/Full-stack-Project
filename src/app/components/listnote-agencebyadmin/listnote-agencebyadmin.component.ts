...
@Component({
  selector: 'app-listnote-agencebyadmin',
  templateUrl: './listnote-agencebyadmin.component.html',
  styleUrls: ['./listnote-agencebyadmin.component.css']
})
export class ListnoteAgencebyadminComponent {
