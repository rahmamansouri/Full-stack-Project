...
@Component({
  selector: 'app-detailnote-hotelbyclient',
  templateUrl: './detailnote-hotelbyclient.component.html',
  styleUrls: ['./detailnote-hotelbyclient.component.css']
})
export class DetailnoteHotelbyclientComponent {
  //---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
