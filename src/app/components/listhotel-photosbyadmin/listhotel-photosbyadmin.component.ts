...
@Component({
  selector: 'app-listhotel-photosbyadmin',
  templateUrl: './listhotel-photosbyadmin.component.html',
  styleUrls: ['./listhotel-photosbyadmin.component.css']
})
export class ListhotelPhotosbyadminComponent {
