...
@Component({
  selector: 'app-detailhotel-photosbyagence',
  templateUrl: './detailhotel-photosbyagence.component.html',
  styleUrls: ['./detailhotel-photosbyagence.component.css']
})
export class DetailhotelPhotosbyagenceComponent {
