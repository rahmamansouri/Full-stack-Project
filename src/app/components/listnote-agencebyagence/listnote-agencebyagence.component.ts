...
@Component({
  selector: 'app-listnote-agencebyagence',
  templateUrl: './listnote-agencebyagence.component.html',
  styleUrls: ['./listnote-agencebyagence.component.css']
})
export class ListnoteAgencebyagenceComponent {
