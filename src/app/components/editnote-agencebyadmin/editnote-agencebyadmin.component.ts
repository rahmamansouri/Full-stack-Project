...
@Component({
  selector: 'app-editnote-agencebyadmin',
  templateUrl: './editnote-agencebyadmin.component.html',
  styleUrls: ['./editnote-agencebyadmin.component.css']
})
export class EditnoteAgencebyadminComponent {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatenoteAgence(id, this.editForm.value).subscribe({
          complete: () => {
            ...
            //this.router.navigateByUrl('/adminlistnoteagence');
