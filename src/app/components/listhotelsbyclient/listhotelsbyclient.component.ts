...
@Component({
  selector: 'app-listhotelsbyclient',
  templateUrl: './listhotelsbyclient.component.html',
  styleUrls: ['./listhotelsbyclient.component.css']
})
export class ListhotelsbyclientComponent {
