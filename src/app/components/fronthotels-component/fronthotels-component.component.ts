...
@Component({
  selector: 'app-fronthotels-component',
  templateUrl: './fronthotels-component.component.html',
  styleUrls: ['./fronthotels-component.component.css']
})
export class FronthotelsComponentComponent {
  hotels:any = [];
  criteres:any = [];
  chambres:any = [];
