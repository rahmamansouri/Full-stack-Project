...
@Component({
  selector: 'app-agencecreatedetailreservation3children',
  templateUrl: './agencecreatedetailreservation3children.component.html',
  styleUrls: ['./agencecreatedetailreservation3children.component.css']
})
export class Agencecreatedetailreservation3childrenComponent {
