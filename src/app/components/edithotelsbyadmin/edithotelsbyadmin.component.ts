...
@Component({
  selector: 'app-edithotelsbyadmin',
  templateUrl: './edithotelsbyadmin.component.html',
  styleUrls: ['./edithotelsbyadmin.component.css']
})
export class EdithotelsbyadminComponent {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatehotels(id, this.editForm.value).subscribe({
          complete: () => {
            ...
            //this.router.navigateByUrl('/adminlisthotel');
