...
@Component({
  selector: 'app-agencecreatedetailreservation9children',
  templateUrl: './agencecreatedetailreservation9children.component.html',
  styleUrls: ['./agencecreatedetailreservation9children.component.css']
})
export class Agencecreatedetailreservation9childrenComponent {
...
this.userId = this.authService.getUserId()
  ...
  mainForm() {
    this.reservationDetailsForm = this.fb.group({
      ...
      ageenfant5: ['', [Validators.required]],
      ageenfant6: ['', [Validators.required]],
      ageenfant7: ['', [Validators.required]],
      ageenfant8: ['', [Validators.required]],
      ageenfant9: ['', [Validators.required]],
