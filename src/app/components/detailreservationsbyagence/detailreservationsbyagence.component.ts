...
@Component({
  selector: 'app-detailreservationsbyagence',
  templateUrl: './detailreservationsbyagence.component.html',
  styleUrls: ['./detailreservationsbyagence.component.css']
})
export class DetailreservationsbyagenceComponent {
