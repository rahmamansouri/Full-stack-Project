...
@Component({
  selector: 'app-editreservation-detailsbyclient',
  templateUrl: './editreservation-detailsbyclient.component.html',
  styleUrls: ['./editreservation-detailsbyclient.component.css']
})
export class EditreservationDetailsbyclientComponent {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatereservationDetails(id, this.editForm.value).subscribe({
          complete: () => {
            ...
            //this.router.navigateByUrl('/clientlistreservationdetail');
