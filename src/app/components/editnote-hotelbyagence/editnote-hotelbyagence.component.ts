...
@Component({
  selector: 'app-editnote-hotelbyagence',
  templateUrl: './editnote-hotelbyagence.component.html',
  styleUrls: ['./editnote-hotelbyagence.component.css']
})
export class EditnoteHotelbyagenceComponent {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatenoteHotel(id, this.editForm.value).subscribe({
          complete: () => {
            ...
            //this.router.navigateByUrl('/agencelistnotehotel');
