...
@Component({
  selector: 'app-detailcriteresbyclient',
  templateUrl: './detailcriteresbyclient.component.html',
  styleUrls: ['./detailcriteresbyclient.component.css']
})
export class DetailcriteresbyclientComponent {
