...
@Component({
  selector: 'app-detailchambresbyclient',
  templateUrl: './detailchambresbyclient.component.html',
  styleUrls: ['./detailchambresbyclient.component.css']
})
export class DetailchambresbyclientComponent {
  //---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
    ...
    if (!this.editForm.valid) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatechambres(id, this.editForm.value).subscribe({
          complete: () => {
            this.router.navigateByUrl('/chambress-list');
