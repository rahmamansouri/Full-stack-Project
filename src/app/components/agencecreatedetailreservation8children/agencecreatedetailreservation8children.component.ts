...
@Component({
  selector: 'app-agencecreatedetailreservation8children',
  templateUrl: './agencecreatedetailreservation8children.component.html',
  styleUrls: ['./agencecreatedetailreservation8children.component.css']
})
export class Agencecreatedetailreservation8childrenComponent {
