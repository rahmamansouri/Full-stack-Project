...
@Component({
  selector: 'app-listreservationsbyagence',
  templateUrl: './listreservationsbyagence.component.html',
  styleUrls: ['./listreservationsbyagence.component.css']
})
export class ListreservationsbyagenceComponent {
