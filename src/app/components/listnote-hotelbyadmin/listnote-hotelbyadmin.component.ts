...
@Component({
  selector: 'app-listnote-hotelbyadmin',
  templateUrl: './listnote-hotelbyadmin.component.html',
  styleUrls: ['./listnote-hotelbyadmin.component.css']
})
export class ListnoteHotelbyadminComponent {
