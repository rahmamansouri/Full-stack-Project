...
@Component({
  selector: 'app-detailhotelsbyclient',
  templateUrl: './detailhotelsbyclient.component.html',
  styleUrls: ['./detailhotelsbyclient.component.css']
})
export class DetailhotelsbyclientComponent {
  //---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
