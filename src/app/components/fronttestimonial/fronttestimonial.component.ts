...
@Component({
  selector: 'app-fronttestimonial',
  templateUrl: './fronttestimonial.component.html',
  styleUrls: ['./fronttestimonial.component.css']
})
export class FronttestimonialComponent {
