...
@Component({
  selector: 'app-agencecreatedetailreservation5children',
  templateUrl: './agencecreatedetailreservation5children.component.html',
  styleUrls: ['./agencecreatedetailreservation5children.component.css']
})
export class Agencecreatedetailreservation5childrenComponent {
