...
@Component({
  selector: 'app-listreservationsbyadmin',
  templateUrl: './listreservationsbyadmin.component.html',
  styleUrls: ['./listreservationsbyadmin.component.css']
})
export class ListreservationsbyadminComponent {
  //---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
