...
@Component({
  selector: 'app-detailnote-hotelbyagence',
  templateUrl: './detailnote-hotelbyagence.component.html',
  styleUrls: ['./detailnote-hotelbyagence.component.css']
})
export class DetailnoteHotelbyagenceComponent {
  //---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
