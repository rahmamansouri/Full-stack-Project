...
@Component({
  selector: 'app-editcriteresbyadmin',
  templateUrl: './editcriteresbyadmin.component.html',
  styleUrls: ['./editcriteresbyadmin.component.css']
})
export class EditcriteresbyadminComponent {
  submitted = false;
  editForm: FormGroup;
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatecriteres(id, this.editForm.value).subscribe({
          complete: () => {
            ...
            //this.router.navigateByUrl('/adminlistcritere');
