...
@Component({
  selector: 'app-detailcriteresbyadmin',
  templateUrl: './detailcriteresbyadmin.component.html',
  styleUrls: ['./detailcriteresbyadmin.component.css']
})
export class DetailcriteresbyadminComponent {
  //---------------------------------------------------------------
  isloading = false;
  error: any
  userId: string
...
ngOnInit() {
    ...
    this.getcriteres(id);
    this.criteres = this.getcriteres(id);
    ...
    if (!this.editForm.valid) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updatecriteres(id, this.editForm.value).subscribe({
          complete: () => {
            this.router.navigateByUrl('/criteress-list');
